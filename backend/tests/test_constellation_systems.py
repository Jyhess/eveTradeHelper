...
class TestConstellationSystems:
    ...
    def test_get_constellation_systems_with_details(self, region_service):
        ...
        region_id = 10000002
        constellations = region_service.get_region_constellations_with_details(region_id)
        ...
        result = region_service.get_constellation_systems_with_details(constellation_id)
    ...
    def test_get_constellation_systems_structure(self, region_service):
